...
public class File extends DTO {
	...
	public File(String fileId,int num, String orgFileNnm, String division, String saveFileNm, long fSize, String ext,
	...
	public String getOrgFileNnm() {
		return orgFileNm;
	}


	public void setOrgFileNm(String orgFileNnm) {
		this.orgFileNm = orgFileNnm;
	}
