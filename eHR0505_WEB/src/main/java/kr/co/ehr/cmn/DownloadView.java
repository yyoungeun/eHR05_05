...
/*
 * Spring MVC 사용 시 DispatcherServlet 기능을 사용 한다. requestUri 에 따라 Controller 로 분기를
 * 하고, 비지니스 로직 처리 후 Resolver 를 사용하여 해당 JSP 파일을 찾아 응답 하게 되는데 그 사이의 시점을 잡아 처리 하는
 * 부분이 AbstractView 의 기능이다.
...
public class DownloadView extends AbstractView {
	...
	private void setDownloadFileName(String fileName,
		...
		String userAgent = request.getHeader("User-Agent"); //브라우저 정보 꺼낼 수 있다.
		LOG.debug("2===========================================");
		...
		boolean idIe = (userAgent.indexOf("MSIE") != -1); //인터넷 익스플로러 확인
